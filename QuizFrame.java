...
public class QuizFrame extends JFrame {
    ...
    */
    ...
    /**
        Creates the heading title that appears on the top left.
    */
    ...
    /**
        Creates the heading display that appears on the top center.
        Displays information and provides feedback.
    */
    ...
    /**
        Creates the home button specific to the student. Removes the
        question panel and creates the home panel. Becomes hidden
        after clicking.
    */
    ...
    /**
        Creates the home button specific to the supervisor. Removes the
        supervisor panel and creates the home panel. Becomes hidden
        after clicking.
    */
    ...
    /**
        Creates the home button panel that appears on the top right. Holds
        the two home buttons. The buttons are hidden at the home screen.
    */
    ...
    /**
        Creates the main heading panel that holds the heading title,
        heading display, and home button panel.
    */
    ...
    */
    ...
    /**
        Creates the welcome message that appears above the user buttons.
    */
    ...
    */
    ...
    /**
        Creates the main panel that holds all other panels and components.
    */
    ...
    /**
        Creates the label timer used for the heading display. When called,
        the timer clears the heading display text after three seconds.
    */
    ...
    /**
        Creates the question panel (student area).
    */
    ...
    */
    ...
    /**
        Starts the quiz. Called after clicking on the student button at the
        home screen. First attempts to load quiz questions. If successful,
        creates the actual quiz components and proceeds to the first question.
    */
    ...
    /**
        Attempts to load quiz questions.
    */
    ...
    */
    ...
    /**
        Creates the question number label that appears above the question.
    */
    ...
    */
    ...
    /**
        Creates the radio buttons representing answer choices.
    */
    ...
    /**
        Creates the submit button that appears below the answer choices.
    */
    ...
    */
    ...
    /**
        Creates the button panel that holds the radio buttons.
    */
    ...
    /**
        Creates the bottom label that displays the final score.
    */
    ...
    /**
        Creates the save panel that appears below the bottom label. Holds
        the components related to saving a score.
    */
    ...
    /**
        Creates the save label that appears on the bottom left.
    */
    ...
    /**
        Creates the name field that appears on the bottom center.
    */
    ...
    /**
        Creates the save score button that appears on the bottom right.
    */
    ...
    /**
        Adds all of the quiz components to the question panel.
    */
    ...
    /**
        Takes appropriate action after an answer is submitted, whether it
        is correct or not.
    */
    ...
    /**
        Disables the radio buttons (answer choices).
    */
    ...
    /**
        Enables the radio buttons (answer choices).
    */
    ...
    /**
        Attempts to save a name and score.
    */
    ...
    /**
        Prepares a question and its related components.
    */
    ...
    /**
        Creates the supervisor components.
    */
    ...
    /**
        Creates the supervisor top label.
    */
    ...
    /**
        Creates the add questions button.
    */
    ...
    /**
        Creates the view scores button.
    */
    ...
    /**
        Creates the add question panel. The panel holds the first label
        and text field.
    */
    ...
    /**
        Creates the add question label.
    */
    ...
    /**
        Creates the add question text field.
    */
    ...
    /**
        Creates the add answer panel. The panel holds the second label
        and text field.
    */
    ...
    */
    ...
    /**
        Creates the add answer text field.
    */
    ...
    /**
        Creates the add choice one panel. The panel holds the third label
        and text field.
    */
    ...
    /**
        Creates the add choice one label.
    */
    ...
    /**
        Creates the add choice one text field.
    */
    ...
    /**
        Creates the add choice two panel. The panel holds the fourth label
        and text field.
    */
    ...
    /**
        Creates the add choice two label.
    */
    ...
    /**
        Creates the add choice two text field.
    */
    ...
    /**
        Creates the add choice three panel. The panel holds the fifth label
        and text field.
    */
    ...
    /**
        Creates the add choice three label.
    */
    ...
    /**
        Creates the add choice three text field.
    */
    ...
    /**
        Creates the question submit button. Will only submit when all the
    ...
    */
    ...
    /**
        Creates the scores table panel.
    */
    ...
    /**
        Adds all of the supervisor components to the supervisor panel.
    */
    ...
    /**
        Attempts to add a question to the questions.txt file.
    */
    ...
    /**
        Attempts to load and display student scores.
    */
